...
public class GongzuohuibaoView extends GongzuohuibaoEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 工作类型的值
		*/
		private String gongzuohuibaoValue;
	...
	public GongzuohuibaoView(GongzuohuibaoEntity gongzuohuibaoEntity) {
		try {
			...
			* 获取： 工作类型的值
			*/
			public String getGongzuohuibaoValue() {
				return gongzuohuibaoValue;
			}
			/**
			* 设置： 工作类型的值
			*/
			public void setGongzuohuibaoValue(String gongzuohuibaoValue) {
				this.gongzuohuibaoValue = gongzuohuibaoValue;
			}
